...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/google/GoogleSignIn-iOS.git", .revision("HEAD")),
    ...
    targets: [
        .target(name: "___PRODUCT___", dependencies: ["QMobileUI", "QMobileAPI", "Prephirences", "GoogleSignIn"], path: "Sources")
    ]
)
